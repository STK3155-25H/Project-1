...
\begin{axis}[
    ...
    ylabel={MSE},
    title={LASSO Regression With Stochastic Gradient Descent},
...
\end{axis}
\end{tikzpicture}
\caption{The MSE is plotted as a function of polynomial degree, for different gradient descents methods using stochastic gradient descent.}
