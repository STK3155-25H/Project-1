...
\begin{axis}[
    ...
    ylabel={MSE},
    title={RIDGE Regression With Advanced GD Methods},
...
\end{axis}
\end{tikzpicture}
\caption{Test MSE of Ridge regression vs. polynomial degree for analytical solution and iterative optimizers (vanilla GD, momentum, Adagrad, RMSProp, Adam, $\eta=0.01$), showing differences in convergence and generalization.}
\label{fig:AGD_RIDGE}
\end{figure}
