...
\end{axis}
\end{tikzpicture}
\caption{Flops estimate of our implementation of different methods. The plot compares vanilla gradient descent, momentum, Adam on the number of floating point operations.}
\label{fig:Flops}
\end{figure}