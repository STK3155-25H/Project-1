...
\end{axis}
\end{tikzpicture}
\caption{Test MSE vs. polynomial degree for varying dataset sizes $n$. For small $n$ (40, 50), MSE rises at high degrees due to overfitting, while for larger $n$ (100, 500, 1000), MSE decreases and stabilizes, illustrating improved generalization with more data.}
\label{fig:OLS_graph}
\end{figure}
