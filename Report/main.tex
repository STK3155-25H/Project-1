...
\begin{itemize}
    ...
    \item \textbf{Cross-Validation (Part~H):} for each run we instantiate one KFold with shuffle=True and random\_state $=s_r$, so folds are identical across degrees and models within the run.
\end{itemize}
