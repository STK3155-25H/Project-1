...
Finally, Figure~\ref{fig:fig:pareto_r2_time_allinone} summarizes the joint accuracy–efficiency trade–off by plotting test $R^2$ against wall–clock fit time (log scale on the $x$–axis). 
