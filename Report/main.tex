...
The benchmarks results were obtained in compliance with the procedures decribed by paragraph \ref{sec:results_setup}. In particular the results were obtained across an average on \(N_{runs} = 30\) on polynomials of different degrees  and applying the forrlowing parameters:
...
Usecases in wich iterative gradient descent methods shine are in fact NNs, where a very large nubmber of parameters need to be optimized.
