...
For OLS, as shown in the Figure \ref{fig:AGD_OLS_SGD}, SGD converges to a solution with MSE values that are slightly higher than those obtained with standard gradient descent methods, due to the inherent noise in the updates.           
However, with an appropriate learning rate, SGD can achieve comparable performance to batch methods.            
